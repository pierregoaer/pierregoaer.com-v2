    ...
    return (
        <>
            ...
            <meta property="og:image"
                  content={`https://res.cloudinary.com/dg8awj55m/image/upload/c_fill,h_500,w_800,f_auto/v1682719065/website-lending/electricien-nimes/images/${curBlog.hero_image_url}`}/>
        </>
    )
}
        ...
        <Layout>
            <article>
                ...
                <div className={styles.shareBtnsContainer}>
                    ...
                    <a href={`https://linkedin.com/shareArticle?&url=https://pierregoaer.com/blog/${curBlog.url}`}
                       target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
