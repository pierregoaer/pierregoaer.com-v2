        ...
        <section className={styles.homeContact} id="contact">
            <div className={styles.homeContactInner}>
                <div className={styles.introText}>
                    <h2>Contact</h2>
                    <p>I can be reached on social media (<a href="https://www.linkedin.com/in/pierregoaer/"
                                                       target="_blank"
                    ...
                    <a href="mailto:hello@pierregoaer.com" className={`btn-primary ${styles.cta}`}>Get in Touch</a>
