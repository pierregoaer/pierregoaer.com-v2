        ...
        <section className={styles.homeAboutMe} id="about">
            <div className={styles.inner}>
                ...
                <p>I've always had a passion for solving problems and trying to understand how things work. This
                    naturally led me to pursue mechanical engineering as a career and after graduating from my Master's
                    at INSA Lyon (France), I got right to work with <a
                        href="https://www.claas-group.com/press-corporate-communications/press-releases/claas-launches-the--future-factory--in-le-mans-/2487928"
                        target="_blank" className="text-link">Claas Tractor <svg xmlns="http://www.w3.org/2000/svg"
                                                                                 viewBox="0 0 24 24">
                        <path
                ...
                <p>I ultimately moved to Canada and worked for almost 3 years as a digital project manager. Being a
                    problem-solver at heart, I decided to go back to something that is more engineering-oriented and
                    learned how to code.</p>
